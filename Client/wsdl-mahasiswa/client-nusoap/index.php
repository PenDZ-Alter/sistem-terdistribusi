...
<legend>Ubah Data</legend>	
	<form name="form1" method="post" action="proses.php" class="form-inline">
		...
		<input type="text" name="alamat" class="input-medium" placeholder="Nama Mahasiswa" value="<?=$r['alamat']?>">
		<input type="text" name="telepon" class="input-medium" placeholder="Nama Mahasiswa" value="<?=$r['telepon']?>">
