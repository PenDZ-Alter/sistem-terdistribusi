...
<body>
  ...
  <fieldset>
    ...
    <? } else { ?>
    <legend>Home</legend>
    Aplikasi sederhana ini menggunakan WSDL (Web Service Description Language) dengan format data XML (Extensible Markup Language). Server menggunakan WSDL dan NuSOAP, Client menggunakan WSDL dan SOAP Client
    <? } ?>
  </fieldset>
</body>
</html>