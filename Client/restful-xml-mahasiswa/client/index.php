...
<legend>Tambah Data</legend>	
	...
	<form class="form-horizontal" name="form1" method="POST" action="proses.php" novalidate>
		...
		<div class="control-group">
			<label class="control-label" for="telepon">No Telp</label>
			<div class="controls">
				<input type="text" name="telepon" class="input-medium" placeholder="No Telp"
					rel="tooltip" data-placement="right" title="Masukkan Nomor Telepon"
					required data-validation-required-message="Harus diisi">
			</div>
		</div>
		<div class="control-group">
...
<legend>Ubah Data</legend>	
	<form name="form1" method="post" action="proses.php" class="form-inline">
		...
		<input type="text" name="alamat" class="input-medium" placeholder="Alamat" value="<?=$r->mahasiswa->alamat?>">
		<input type="text" name="telepon" class="input-medium" placeholder="No Telp" value="<?=$r->mahasiswa->telepon?>">
